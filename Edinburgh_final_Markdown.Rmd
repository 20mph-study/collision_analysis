...
#Path
gdb_path <- paste0(dir_path, "Edin shapefiles/20mph.gdb")
...
control_gdb_path <- paste0(dir_path, "Edin shapefiles/SG_DataZoneBdry_2011")
...
```{r,echo=FALSE,warning=FALSE,message=FALSE} 
#Read data
edin_road_data <- read_csv(paste0(dir_path, "/Edin dataset/edin_road_data.csv"))
control_zone_data <- read_csv(paste0(dir_path, "/Edin dataset/edin_control_data.csv"))
casualties_data <- read_csv(paste0(dir_path, "/Edin dataset/edin_casualties_data.csv"))
rd_2019 <- read_csv(paste0(dir_path, "/Edin dataset/data2019.csv"))
