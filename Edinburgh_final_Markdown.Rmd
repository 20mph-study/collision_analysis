...
edin_road_data$Accident_Severity[edin_road_data$Accident_Severity == 1] <- "fatal"
edin_road_data$Accident_Severity[edin_road_data$Accident_Severity == 2] <- "Serious"
edin_road_data$Accident_Severity[edin_road_data$Accident_Severity == 3] <- "Slight"
