...
mergedclass <- mergedclass[,-c(1,2,38,41,46,47,48)]
...
not <- delete_na(not_changed[not_changed$X1st_Road_Class== "Unclassified" & not_changed$LAYER == "30mph", ], "Accident_Index")
leaflet_map(not,edin_cons_streets)
...
```{r,echo=FALSE,warning=FALSE,message=FALSE}
leaflet_map(mergedDf[mergedDf$Date >= "2013-07-31" & mergedDf$Date <= "2013-07-30" ,],edin_cons_streets)
```
