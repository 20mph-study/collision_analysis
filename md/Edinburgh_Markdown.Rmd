...
edin_rd <- rd %>% filter(rd$`Local_Authority_(District)` == "923" ) 
rd <- rd %>% filter(rd$`Local_Authority_(District)` %in% c("910","925","918","935","926")) 
...
edin_rd <- data.frame(edin_rd,coord)
edin_rd <-  rename(edin_rd,c("X"="Longitude","Y"="Latitude")) 

edin_road_data <- rbind.fill(edin_rd,data)
...
data1 <- rowid_to_column(data,"index_ID")
```
...
rd2016$Date <- as.Date(rd2016$Date,format="%d/%m/%Y")
rd2016 <- rd2016 %>% filter(rd2016$Date >= "2016-07-21" & rd2016$Date <= "2016-12-31" )
rd2016 <- rd2016 %>% mutate(year = format(as.Date(rd2016$Date, format="%m/%d/%Y"),"%Y"))
rd2016 <- rd2016 %>% filter(rd2016$Speed_limit %in% c(20,30))
rd2016$`Local_Authority_(District)` <- as.character(rd2016$`Local_Authority_(District)`)
rd2016 <- delete_na(rd2016,c("Longitude","Latitude"))
rd2016 <- rd2016 %>% filter(rd2016$`Local_Authority_(District)` %in% c("923","910","925","918","935","926")) 
```

```{r}
rd2017 <- read_csv(paste0(dir_path, "/collisions 2017.csv"))
rd2017$Date <- as.Date(rd2017$Date,format="%d/%m/%Y")
rd2017 <- rd2017 %>% mutate(year = format(as.Date(rd2017$Date, format="%m/%d/%Y"),"%Y"))
rd2017 <- rd2017 %>% filter(rd2017$Speed_limit %in% c(20,30))
rd2017$`Local_Authority_(District)` <- as.character(rd2017$`Local_Authority_(District)`)
rd2017 <- delete_na(rd2017,c("Longitude","Latitude"))
rd2017 <- rd2017 %>% filter(rd2017$`Local_Authority_(District)` %in% c("923","910","925","918","935","926")) 
```
...
rd2018$Date <- as.Date(rd2018$Date,format="%d/%m/%Y")
rd2018 <-rd2018 %>% filter(rd2018$Date >= "2018-01-01" & rd2018$Date <= "2018-03-05" )
rd2018 <- rd2018 %>% mutate(year = format(as.Date(rd2018$Date, format="%m/%d/%Y"),"%Y"))
rd2018 <- rd2018 %>% filter(rd2018$Speed_limit %in% c(20,30))
rd2018$`Local_Authority_(District)` <- as.character(rd2018$`Local_Authority_(District)`)
rd2018 <- delete_na(rd2018,c("Longitude","Latitude"))
rd2018 <- rd2018 %>% filter(rd2018$`Local_Authority_(District)` %in% c("923","910","925","918","935","926")) 
```
...
```{r,echo=FALSE,warning=FALSE,message=FALSE}
count_zones <- buffer_data(data1,edin_impl_zones)
total_zones <- count_zones
```
