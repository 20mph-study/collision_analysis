...
edin_road_data_3 <-  rename(mergedDf,c("Longitude before" = "Longitude", "Latitude before" = "Latitude")) 
edin_road_data_3 <- edin_road_data_3[,-c(36,37,41,42,44)]
edin_zone_data <- rbind.fill(edin_zone_rd,edin_road_data_3)

data3 <- edin_zone_data

data1 <- edin_zone_data
data1 <- rowid_to_column(data1,"index_ID")
```
...
```{r,echo=FALSE,warning=FALSE,message=FALSE}
total_zones <- buffer_data(data3,edin_impl_zones)
```
