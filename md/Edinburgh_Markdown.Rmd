...
mergedDf <- read_csv(paste0(dir_path, "/final_data.csv"))
mergedDf <- mergedDf[,-c(36,39,40,42:48)]
```
...
final_df <- final_df[,-c(1,36:38,43:48)]
head(final_df[,c(1,34:38)])
