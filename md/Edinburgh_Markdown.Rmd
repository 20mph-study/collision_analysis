...
sum_pre <-sum(pre[pre$LAYER == "30mph",2],pre[pre$LAYER == "20mph existing streets",2],s1,pre[pre$LAYER == "40mph",2])
sum_post <-sum(post[post$LAYER == "30mph",2],post[post$LAYER == "20mph existing streets",2],s2,post[post$LAYER == "40mph",2])

#create column pre and post
collisions_pre_20mph <- c(pre[pre$LAYER == "30mph",2],pre[pre$LAYER == "20mph existing streets",2],s1,pre[pre$LAYER == "40mph",2],sum_pre)
collisions_post_20mph <- c(post[post$LAYER == "30mph",2],post[post$LAYER == "20mph existing streets",2],s2,post[post$LAYER == "40mph",2],sum_post)
...
sum_pre_2 <-sum(p[p$Speed_limit == 20,2],p[p$Speed_limit == 30,2],p[p$Speed_limit == 40,2])
sum_post_2 <-sum(po[po$Speed_limit == 20,2],po[po$Speed_limit == 30,2],po[po$Speed_limit == 40,2])

collisions_pre_20mph <- c(p[p$Speed_limit == 20,2],p[p$Speed_limit == 30,2],p[p$Speed_limit == 40,2],sum_pre_2)
collisions_post_20mph <- c(po[po$Speed_limit == 20,2],po[po$Speed_limit == 30,2],po[po$Speed_limit == 40,2],sum_post_2)
