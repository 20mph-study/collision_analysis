...
data0 <- edin_road_data[edin_road_data$Date >= "2013-01-01" & edin_road_data$Date <= "2013-12-31", ]
...
kable(df,caption = "Effect estimate", booktabs = TRUE, valign = 't') %>% kable_styling(bootstrap_options = c("hover","striped"),font_size = 15 )
...
```{r,echo=FALSE,warning=FALSE,message=FALSE}
count_zones <- buffer_data(data,edin_impl_zones)
```
