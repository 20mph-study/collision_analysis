table_zones <- function(total_zones){
  ...
  zone_1a_p <- nrow(total_zones %>% filter(total_zones$Date > "2016-07-31" & total_zones$Date <= "2018-12-31" & total_zones$ImplementationZone %in% c("1")))
  zone_1b_p <- nrow(total_zones %>% filter(total_zones$Date > "2016-07-31" & total_zones$Date <= "2018-12-31" & total_zones$ImplementationZone %in% c("7")))
  zone_2_p <-  nrow(total_zones %>% filter(total_zones$Date > "2017-02-28" & total_zones$Date <= "2018-12-31" & total_zones$ImplementationZone %in% c("2")))
  zone_3_p <-  nrow(total_zones %>% filter(total_zones$Date > "2017-02-28" & total_zones$Date <= "2018-12-31" & total_zones$ImplementationZone %in% c("3")))
  zone_4_p <-  nrow(total_zones %>% filter(total_zones$Date > "2017-08-16" & total_zones$Date <= "2018-12-31" & total_zones$ImplementationZone %in% c("4")))
  zone_5_p <-  nrow(total_zones %>% filter(total_zones$Date > "2017-08-16" & total_zones$Date <= "2018-12-31" & total_zones$ImplementationZone %in% c("5")))
  zone_6_p <-  nrow(total_zones %>% filter(total_zones$Date > "2018-03-05" & total_zones$Date <= "2018-12-31" & total_zones$ImplementationZone %in% c("6")))
